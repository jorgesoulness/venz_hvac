...
class RTS_Search_Button extends Widget_Base
{
    ...
    protected function render()
    {
        ...
        <form class="rts-search-button-wrapper" role="search" action="<?php echo home_url(); ?>" method="get">
            ...
            <?php } elseif ($settings['layout'] == 'icon_text' or $settings['layout'] == 'text') { ?>
            ...
            <?php if ($settings['layout'] == 'default') : ?>
                ...
                <div class="rts-single-wized search">
                    <div class="wized-body mt--0">
                        <form role="search" method="get" class="rts-search-wrapper" action="<?php echo esc_url(home_url('/')); ?>">
                            <input class="Search search-faq" type="text" name="s" placeholder="Enter Keyword" value="<?php echo get_search_query(); ?>">
                            <button class="btn-faq" type="submit"><i class="fal fa-search"></i></button>
                        </form>
                    </div>
                </div>
