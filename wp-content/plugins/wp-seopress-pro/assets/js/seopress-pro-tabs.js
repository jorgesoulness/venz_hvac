jQuery(document).ready(function ($) {
    ...
    // LLMS.txt placeholder insertion
    $('.seopress-llms-insert').on('click', function(e) {
        e.preventDefault();
        var textarea = $('.seopress_llms_file');
        ...
        var newValue = value.substring(0, cursorPos) + textToInsert + value.substring(cursorPos);
