...
<form method="post" action="<?php echo esc_url( admin_url( 'options.php' ) ); ?>" class="seopress-option">
	...
	<div id="seopress-tabs" class="wrap">
		<?php
				$plugin_settings_tabs = array(
					...
					'tab_seopress_llms'           => esc_html__( 'llms.txt', 'wp-seopress-pro' ),
				...
				if ( defined( 'SUBDOMAIN_INSTALL' ) && false === constant( 'SUBDOMAIN_INSTALL' ) && defined( 'DOMAIN_CURRENT_SITE' ) && $current_site === constant( 'DOMAIN_CURRENT_SITE' ) ) {// if custom domains with subdirectories
					unset( $plugin_settings_tabs['tab_seopress_robots'], $plugin_settings_tabs['tab_seopress_llms'] );
				}
		...
		<?php
		if ( 'tab_seopress_local_business' === $current_tab ) {
			echo 'active';
		}
		?>
		...
		<div class="seopress-tab 
		<?php
		if ( 'tab_seopress_woocommerce' === $current_tab ) {
			echo 'active';
		}
		?>
		...
		<div class="seopress-tab 
		<?php
		if ( 'tab_seopress_edd' === $current_tab ) {
			echo 'active';
		}
		?>
		" id="tab_seopress_edd">
		...
		<div class="seopress-tab 
		<?php
		if ( 'tab_seopress_alerts' === $current_tab ) {
			echo 'active';
		}
		?>
		...
		<div class="seopress-tab 
		<?php
		if ( 'tab_seopress_dublin_core' === $current_tab ) {
			echo 'active';
		}
		?>
		...
		<div class="seopress-tab 
		<?php
		if ( 'tab_seopress_rich_snippets' === $current_tab ) {
			echo 'active';
		}
		?>
	" id="tab_seopress_rich_snippets">
		...
		<div class="seopress-tab 
		<?php
		if ( 'tab_seopress_ai' === $current_tab ) {
			echo 'active';
		}
		?>
	" id="tab_seopress_ai"><?php do_settings_sections( 'seopress-settings-admin-ai' ); ?>
		...
		<div class="seopress-tab 
		<?php
		if ( 'tab_seopress_breadcrumbs' === $current_tab ) {
			echo 'active';
		}
		?>
	" id="tab_seopress_breadcrumbs"><?php do_settings_sections( 'seopress-settings-admin-breadcrumbs' ); ?>
		...
		<div class="seopress-tab 
		<?php
		if ( 'tab_seopress_page_speed' === $current_tab ) {
			echo 'active';
		}
		?>
	" id="tab_seopress_page_speed"><?php do_settings_sections( 'seopress-settings-admin-page-speed' ); ?>
		...
		<div class="seopress-tab 
		<?php
		if ( 'tab_seopress_inspect_url' === $current_tab ) {
			echo 'active';
		}
		?>
	" id="tab_seopress_inspect_url"><?php do_settings_sections( 'seopress-settings-admin-inspect-url' ); ?>
		...
		<!-- Robots -->
		<?php
		if ( ( ! defined( 'SUBDOMAIN_INSTALL' ) || ( defined( 'SUBDOMAIN_INSTALL' ) && true === constant( 'SUBDOMAIN_INSTALL' ) ) ) // if multisite sub-domains
		...
		<div class="seopress-tab 
			<?php
			if ( 'tab_seopress_robots' === $current_tab ) {
				echo 'active';
			}
			?>
	" id="tab_seopress_robots"><?php do_settings_sections( 'seopress-settings-admin-robots' ); ?>
		...
		<!-- LLMS -->
		<?php if ( ! ( defined( 'SUBDOMAIN_INSTALL' ) && false === constant( 'SUBDOMAIN_INSTALL' ) && defined( 'DOMAIN_CURRENT_SITE' ) && $current_site === constant( 'DOMAIN_CURRENT_SITE' ) ) ) { ?>
			<div class="seopress-tab
				<?php
				if ( 'tab_seopress_llms' === $current_tab ) {
					echo 'active';
				}
				?>
		" id="tab_seopress_llms"><?php do_settings_sections( 'seopress-settings-admin-llms' ); ?>
			</div>
		<?php } ?>
		...
		<div class="seopress-tab 
		<?php
		if ( 'tab_seopress_news' === $current_tab ) {
			echo 'active';
		}
		?>
	" id="tab_seopress_news">
		...
		<div class="seopress-tab 
		<?php
		if ( 'tab_seopress_404' === $current_tab ) {
			echo 'active';
		}
		?>
	" id="tab_seopress_404"><?php do_settings_sections( 'seopress-settings-admin-monitor-404' ); ?>
		...
		<div class="seopress-tab 
			<?php
			if ( 'tab_seopress_htaccess' === $current_tab ) {
				echo 'active';
			}
			?>
	" id="tab_seopress_htaccess"><?php do_settings_sections( 'seopress-settings-admin-htaccess' ); ?>
		...
		<div class="seopress-tab 
		<?php
		if ( 'tab_seopress_rss' === $current_tab ) {
			echo 'active';
		}
		?>
	" id="tab_seopress_rss"><?php do_settings_sections( 'seopress-settings-admin-rss' ); ?>
		...
		<div class="seopress-tab 
			<?php
			if ( 'tab_seopress_white_label' === $current_tab ) {
				echo 'active';
			}
			?>
