<?php //phpcs:ignore
/**
 * SEOPress PRO Redirections callbacks.
 *
...
<label for="seopress_404_enable">
	...
	<?php
	if ( isset( $options['seopress_404_enable'] ) ) {
		esc_attr( $options['seopress_404_enable'] );
	}
}

/**
 * 404 cleaning callback.
 *
 * @return void
 */
...
<p>
	...
	<?php
	if ( isset( $options['seopress_404_cleaning'] ) ) {
		esc_attr( $options['seopress_404_cleaning'] );
	}
}

/**
 * 404 redirect home callback.
 *
 * @return void
 */
...
<select id="seopress_404_redirect_home" name="seopress_pro_option_name[seopress_404_redirect_home]">
	...
	<?php
	if ( isset( $options['seopress_404_redirect_home'] ) ) {
		esc_attr( $options['seopress_404_redirect_home'] );
	}
}

/**
 * 404 redirect custom URL callback.
 *
 * @return void
 */
...
/**
 * 404 redirect status code callback.
 *
 * @return void
 */
...
<select id="seopress_404_redirect_status_code" name="seopress_pro_option_name[seopress_404_redirect_status_code]">
	...
	<?php
	if ( isset( $options['seopress_404_redirect_status_code'] ) ) {
		esc_attr( $options['seopress_404_redirect_status_code'] );
	}
}

/**
 * 404 enable mails callback.
 *
 * @return void
 */
...
<label for="seopress_404_enable_mails">
	...
	<?php
	if ( isset( $options['seopress_404_enable_mails'] ) ) {
		esc_attr( $options['seopress_404_enable_mails'] );
	}
}

/**
 * 404 enable mails from callback.
 *
 * @return void
 */
...
/**
 * 404 disable automatic redirects callback.
 *
 * @return void
 */
...
<label for="seopress_404_disable_automatic_redirects">
	...
	<?php
	if ( isset( $options['seopress_404_disable_automatic_redirects'] ) ) {
		esc_attr( $options['seopress_404_disable_automatic_redirects'] );
	}
}

/**
 * 404 disable guess automatic redirects 404 callback.
 *
 * @return void
 */
...
<label for="seopress_404_disable_guess_automatic_redirects_404">
	...
	<?php
	if ( isset( $options['seopress_404_disable_guess_automatic_redirects_404'] ) ) {
		esc_attr( $options['seopress_404_disable_guess_automatic_redirects_404'] );
	}
}

/**
 * Get redirection pro HTML callback.
 *
 * @return void
 */
