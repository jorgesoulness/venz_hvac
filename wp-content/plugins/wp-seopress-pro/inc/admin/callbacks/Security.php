<?php //phpcs:ignore
/**
 * SEOPress PRO Security callbacks.
 *
...
/**
 * Structured Data Types metabox role callback.
 *
 * @return void
 */
function seopress_advanced_security_metaboxe_sdt_role_callback() {
	...
	<p>
		...
		<?php
		if ( isset( $options['seopress_advanced_security_metaboxe_sdt_role'][ $key ] ) ) {
...
/**
 * Google Analytics widget role callback.
 *
 * @return void
 */
function seopress_advanced_security_ga_widget_role_callback() {
	...
	<p>
		...
		<?php
		if ( isset( $options['seopress_advanced_security_ga_widget_role'][ $key ] ) ) {
...
function seopress_advanced_security_matomo_widget_role_callback() {
	...
	<p>
		...
		<?php
		if ( isset( $options['seopress_advanced_security_matomo_widget_role'][ $key ] ) ) {
