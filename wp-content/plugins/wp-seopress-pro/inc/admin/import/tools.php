<?php //phpcs:ignore
/**
 * SEOPress PRO Import / export CSV tool.
 *
...
<div class="postbox section-tool">
	...
	<div class="inside">
		...
		<ul>
			...
			<li>
				<?php esc_html_e( 'Custom breadcrumbs', 'wp-seopress-pro' ); ?>
			</li>
		</ul>
		<p>
		...
		<form id="seopress-export-csv-form" method="post" enctype="multipart/form-data">
			...
			<p>
				<label>
					...
					<?php echo esc_html( $post_type->label ) . ' <code>[' . esc_html( $post_type->name ) . ']</code>'; ?>
				</label>
			</p>
				<?php
			}
