...
/**
 * SEOPress PRO Analytics section.
 *
...
/**
 * Print section info analytics settings section.
 *
 * @return void
 */
function seopress_pro_analytics_settings_section() {
	?> | <a href="#seopress-analytics-ecommerce"><?php esc_html_e( 'Ecommerce', 'wp-seopress-pro' ); ?></a> | <a href="#seopress-analytics-stats"><?php esc_html_e( 'Stats in Dashboard', 'wp-seopress-pro' ); ?></a>
																			<?php
}
add_action( 'seopress_analytics_settings_section', 'seopress_pro_analytics_settings_section' );

/**
 * Print section info matomo settings section.
 *
 * @return void
 */
function seopress_pro_matomo_settings_section() {
	?>
	 | <a href="#seopress-matomo-stats"><?php esc_html_e( 'Stats in Dashboard', 'wp-seopress-pro' ); ?></a>
																			<?php
}
