...
add_settings_field(
	'seopress_rich_snippets_profilepage_enable', // ID.
	__( 'Enable ProfilePage Schema', 'wp-seopress-pro' ), // Title.
	'seopress_rich_snippets_profilepage_enable_callback', // Callback.
	'seopress-settings-admin-rich-snippets', // Page.
	'seopress_setting_section_rich_snippets' // Section.
);
