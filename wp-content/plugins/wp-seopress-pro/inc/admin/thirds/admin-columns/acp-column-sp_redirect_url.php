...
/**
 * ACP Column for the redirect URL meta key.
 */
class ACP_Column_Sp_Redirect_Url extends AC\Column\Meta implements \ACP\Editing\Editable, \ACP\Sorting\Sortable, \ACP\Export\Exportable, \ACP\Search\Searchable {
	/**
	 * Constructor.
	 */
