...
<div class="menu-area menu_type_">    
    <div class="menu_one">
            ...
            <div class="col-cell header-logo">
                <?php 
                 if (!empty( $coolair_option['wplogo_mobile_rt']['url'] ) ) { ?>
                  <a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img <?php echo wp_kses($mobile_logo_height, 'coolair');?> src="<?php echo esc_url( $coolair_option['wplogo_mobile_rt']['url']); ?>" alt="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>"></a>
                <?php }else{
