...
<?php 
  ...
  if($post_meta_data == ''){
    if(!empty($coolair_option['page_banner_main']['url'])):
      $post_meta_data = $coolair_option['page_banner_main']['url'];
    
    else: {
      $post_meta_data2 = !empty($coolair_option['breadcrumb_bg_color'])? $coolair_option['breadcrumb_bg_color'] : '';
    }
    endif;
  }  
